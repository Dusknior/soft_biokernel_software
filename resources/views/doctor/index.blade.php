    ...
    <main role="main">
        ...
        <div class="py-5" style="background-color: #1E3C40;" id="overlay">
            <div class="container">
                ...
                <div class="list-group mt-4 overlay" id="doctor-list">
                    <h4 class="mb-3" style="color: #B4D2D9;"><strong>Doctores</strong></h4>
                        ...
                        <div href="#" class="list-group-item list-group-item-action rounded"
                            ...
                            <div class="d-flex w-100 justify-content-between">
                                <div class="row mx-0 w-100">
                                    <div class="col">
                                        <br>
                                        <h5 class="mb-1">No hay doctores creados</h5>
                                        <br><br>
                                    </div>
                                </div>
                            </div>
                        ...
                        @foreach ($doctores as $doctor)
                            <div class="list-group-item list-group-item-action rounded mt-4"
                                ...
                                <div class="d-flex w-100 justify-content-between">
                                    <div class="row mx-0 w-100">
                                        <div class="col">
                                            <h5 class="mb-1">Dr. {{ $doctor->firstname }} {{ $doctor->lastname }}
                                                {{ $doctor->second_lastname }}</h5>
                                            <p class="mb-1">Dirrección: {{ $doctor->address }}</p>
                                            <p class="mb-1">Celular: {{ $doctor->cellphone }}</p>
                                            <p class="mb-1">Tipo de Sangre: {{ $doctor->bloodtype }} </p>
                                            <p class="mb-1">Años de Exp.: {{ $doctor->expyears }} </p>
                                            <small>Cumpleaños: {{ $doctor->birhtday }}</small>
                                        </div>
                                        <div class="col-1 d-flex justify-content-end align-items-center">
                                            <a href="{{ url('doctor/' . $doctor->id) . '/edit' }}" type="button">
                                            ...
                                            <form action="{{ url('doctor/' . $doctor->id) }}" method="post">
                                                ...
                                                <button class="btn btn-link" type="submit"
                                                    onclick="return confirm('¿Desea eliminar el doctor?')"><span
