    ...
    <main role="main">
        ...
        <div class="py-5" style="background-color: #1E3C40;" id="overlay">
            <div class="container">
                ...
                <div class="list-group overlay mt-4" id="hospital-list">
                    <h4 class="mb-3" style="color: #B4D2D9;"><strong>Hospitales</strong></h4>
                        ...
                        <div href="#" class="list-group-item list-group-item-action rounded"
                            ...
                            <div class="d-flex w-100 justify-content-between">
                                <div class="row mx-0 w-100">
                                    <div class="col">
                                        <br>
                                        <h5 class="mb-1">No hay hospitales creados</h5>
                                        <br><br>
                                    </div>
                                </div>
                            </div>
                        ...
                        @foreach ($hospitales as $hospital)
                            <div class="list-group-item list-group-item-action rounded mt-4"
                                ...
                                <div class="d-flex w-100 justify-content-between">
                                    <div class="row mx-0 w-100">
                                        <div class="col">
                                            <h5 class="mb-1">{{ $hospital->hospital_name }}</h5>
                                            <p class="mb-1">Dirrección: {{ $hospital->hospital_address }}</p>
                                            <p class="mb-1">Admin.: {{ $hospital->hospital_admin_name }}
                                                {{ $hospital->hospital_admin_lastname }}
                                            </p>
                                            <small>NIT: {{ $hospital->hospital_nit }}</small>
                                        </div>
                                        <div class="col-1 d-flex justify-content-end align-items-center">
                                            <a href="{{ url('hospital/' . $hospital->id) . '/edit' }}" type="button">
                                            ...
                                            <form action="{{ url('hospital/' . $hospital->id) }}" method="post">
                                                ...
                                                <button class="btn btn-link" type="submit"
                                                    onclick="return confirm('¿Desea eliminar el hospital?')"><span
