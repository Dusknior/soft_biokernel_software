    ...
    <div class="container" id="container-form">
        <div class="col-md-12 order-md-4 rounded" style="background-color: #B4D2D9;" id="form-sheet">
            <div class="d-flex flex-row">
                <a href="/paciente" class="mr-3">
                    <span style="font-size: 1.5em;  color: #1E3C40;">
                        <i class="fas fa-chevron-left"></i>
                    </span>
                </a>
                <h3 class="mb-3"><strong>Creación del Paciente</strong></h3>
            </div>
            <form action="{{ url('/paciente') }}" method="post" id="paciente">
                @csrf
                @include('paciente.form',['modo'=>'Guardar'])
            </form>
        </div>
    </div>
    </div>
